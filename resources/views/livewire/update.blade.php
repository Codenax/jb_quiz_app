<div>
    <div class="grid grid-cols-12 gap-3">
        ...
        <div class="col-span-12">
           <button type="submit" wire:click="update()" class="text-center text-white w-full rounded backdrop border border-green-300 h-10 jb-button focus:outline-none px-2 shadow p-2 ">Update Quiz</button>
        </div>
    </div>
</div>
